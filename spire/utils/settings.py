...
BUGOUT_HUMBUG_REDIS_CONNECTIONS_PER_PROCESS_RAW = os.environ.get("BUGOUT_HUMBUG_REDIS_CONNECTIONS_PER_PROCESS")
BUGOUT_HUMBUG_REDIS_CONNECTIONS_PER_PROCESS = 10
if BUGOUT_HUMBUG_REDIS_CONNECTIONS_PER_PROCESS_RAW is not None:
    try:
        BUGOUT_HUMBUG_REDIS_CONNECTIONS_PER_PROCESS = int(BUGOUT_HUMBUG_REDIS_CONNECTIONS_PER_PROCESS_RAW)
    except:
        pass
