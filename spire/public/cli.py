...
def make_journal_public(args: argparse.Namespace) -> None:
    ...
    """
    public_permissions = ["journals.read", "journals.entries.read"]
    if args.entry_create:
        public_permissions.append("journals.entries.create")
    if args.entry_update:
        public_permissions.append("journals.entries.update")
    ...
    with yield_connection_from_env_ctx() as db_session:
        ...
        try:
            ...
            public_journal_json = {
                ...
                "added_permissions": public_permissions,
            }
